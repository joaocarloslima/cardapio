...
if (isset($_POST["create"])){
    ...
    {
        $image_path = "./assets/images/". uniqid() . $_FILES["image"]["name"];
        $image = imagecreatefromjpeg($_FILES["image"]["tmp_name"]);
        $image = imagescale($image, 300, 200);
        //imagefilter($image, IMG_FILTER_BRIGHTNESS, 50);
        //imagefilter($image, IMG_FILTER_CONTRAST, 20);
        //imagefilter($image, IMG_FILTER_COLORIZE, 50, 0, 20);
    ...
    $stmt->bindValue(":imagem", $image_path);
